...
public class RegisteredUserEditShippingDetailsToStorefromReviewPagePlaceOrderTest extends PopupWindows{
	...
	public RegisteredUserEditShippingDetailsToStorefromReviewPagePlaceOrderTest(BaseClass obj) {
		super(obj);
		this.obj=obj;
	}
	...
	public void RegisteredUserEditShippingDetailsToStorefromReviewPagePlaceOrderTestScenario(String machineName,String host,String port,String browser,String os,String browserVersion,String osVersion, String tcId){
		try{
			...
			String ShippingModeStore = checkoutPage.getShippingModeStoreinReviewTab();
			
			testStepPassed("ShippingModeStore : "+ShippingModeStore);
			
			//checkoutPage.verifyShippingToStoreisDisplayedinReviewTab();
			
			if (!ShippingModeStore.equalsIgnoreCase(ShippingModeStandardAddress)) 
			{
				testStepInfo("Shipping Mode is Changed from Ship to Address to Ship to Store");
			}
			else 
			{
				testStepFailed("Shipping Mode is not Changed from Ship to Address to Ship to Store");
			}
...
/*			popupwindows.verifyUSFlagSelected();
			...
			myAccountPage.fillDetails_AddressBook_AddNewAddress1(retrieve("ShipAddrSaved_Firstname"), retrieve("ShipAddrSaved_Lastname"), retrieve("ShipAddrSaved_Address"), retrieve("ShipAddrSaved_City"));

			myAccountPage.select_AddressBook_AddNewAddress_State(retrieve("ShipAddrSaved_State"));

			myAccountPage.fillDetails_AddressBook_AddNewAddress2(retrieve("ShipAddrSaved_Zip"), retrieve("ShipAddrSaved_Telephone"));
			...
			//checkoutPage.verifyCvvisDisplayed();
			
			checkoutPage.EnterCvvinReviewTab(retrieve("CardCvv"));
			
			checkoutPage.EnterSavedCvvinReviewTab(retrieve("CardCvv"));
