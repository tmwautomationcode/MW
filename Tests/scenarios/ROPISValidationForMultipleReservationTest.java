...
public class ROPISValidationForMultipleReservationTest extends PopupWindows{
	...
	public ROPISValidationForMultipleReservationTest(BaseClass obj) {
		super(obj);
		this.obj=obj;
	...
	public void rOPISValidationForMultipleReservationTestScenario(String machineName, String host, String port, String browser, String os, String browserVersion, String osVersion) {
		try{
			...
			clickOnBackToTopLinkInFooter(); 
			ColorFiltervalue = productGridPage.selectColorFilter(retrieve("ColorFilterValue"));
			waitTime(5);
