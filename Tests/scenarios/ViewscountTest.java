...
public class ViewscountTest extends PopupWindows{
	...
	public ViewscountTest(BaseClass obj) {
		super(obj);
		this.obj=obj;
	...
	public void viewscountTestScenario(String machineName,String host,String port,String browser,String os,String browserVersion,String osVersion, String tcId){
		try{
			...
			productDescriptionPage.verifyviewscountinQV();
			...
			departmentnavigation.selectCategoryFromDepartmentMenu(retrieve("DepartmentName2"),retrieve("SubCategoryName2"));
			...
			productDescriptionPage.verifyviewscountinPDP();
			...
			departmentnavigation.selectCategoryFromDepartmentMenu(retrieve("DepartmentName3"),retrieve("SubCategoryName3"));
