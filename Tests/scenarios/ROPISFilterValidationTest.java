...
public class ROPISFilterValidationTest extends PopupWindows{
	...
	public ROPISFilterValidationTest(BaseClass obj) {
		super(obj);
		this.obj=obj;
	...
	public void rOPISFilterValidationTestScenario(String machineName, String host, String port, String browser, String os, String browserVersion, String osVersion) {
		try{
