...
public class ROPISAddProductFromRecommedationWidgetInReserveConfirmationPopupTest extends PopupWindows{
	...
	public ROPISAddProductFromRecommedationWidgetInReserveConfirmationPopupTest(BaseClass obj) {
		super(obj);
		this.obj=obj;
	...
	public void rOPISAddProductFromRecommedationWidgetInReserveConfirmationPopupTestScenario(String machineName, String host, String port, String browser, String os, String browserVersion, String osVersion) {
		try{
			...
			waitTime(3);
			productDescriptionPage.addProductFromROPISReservationConfirmpageFromMultipleCertonaWidget();
