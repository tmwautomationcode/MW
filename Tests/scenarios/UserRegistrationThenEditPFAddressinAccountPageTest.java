...
public class UserRegistrationThenEditPFAddressinAccountPageTest extends PopupWindows{	
	...
	public UserRegistrationThenEditPFAddressinAccountPageTest(BaseClass obj) {
		super(obj);
		this.obj=obj;
	}
	...
	public void userRegistrationThenEditPFAddressinAccountPageTestScenario(String machineName,String host,String port,String browser,String os,String browserVersion,String osVersion, String tcId){
		try{
			...
			myAccountPage.clickPFaddressEditLinkinMyAccountPage();
			
			myAccountPage.fillEditPFAddressDetails(retrieve("PFFirstName"), retrieve("PFLastName"), retrieve("PFAddress"), retrieve("PFCity"), retrieve("PFState"), retrieve("PFZipcode"), retrieve("PFTelephone"));
			
			myAccountPage.verify_NewPFAddress_Updated_MessageandClose();
