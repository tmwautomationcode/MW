...
public class DepartmentLinksAndSubCategoryLinksNavigationTest extends PopupWindows{
	...
	public DepartmentLinksAndSubCategoryLinksNavigationTest(BaseClass obj) {
		super(obj);
		this.obj=obj;
	}
	...
	public void departmentLinksAndSubCategoryLinksNavigationTestScenario(String machineName,String host,String port,String browser,String os,String browserVersion,String osVersion, String tcId){
		try{
			...
			testStepFailed("Exception occured");
		}finally{
			testStepInfo("");
			testStepInfo("*******************************");
