...
public class ImageSizeValidationTest extends PopupWindows{
	...
	public void imageSizeValidationTestScenario(String machineName,String host,String port,String browser,String os,String browserVersion,String osVersion){
		try
		{
			...
			for (WebElement img : listofimages) 
			{
				...
				else 
				{
					...
					if (ImageSize<150.00) 
					{
						...
						testStepPassed("The Image Size is less than 150 KB");
					...
					else 
					{
						...
						testStepWarning("Warning : The Image Size is greater than 150 KB");
			...
			if (TotalImageSize<1500.00) 
			{
				
				testStepPassed("The Total Images Size Count is less than 1500 KB");
			...
			else 
			{
				...
				testStepWarning("Warning : The Total Images Size Count is greater than 1500 KB");
